  ...
  <style>
    ...
    * {{
    ...
    @media (max-width: 1400px) {{
      ...
      .nav-tab-btn {{ padding: 6px 9px; font-size: 0.8rem; }}
    }}
    ...
    @media (max-width: 860px) {{
      ...
      .nav-tabs {{ order: 3; width: 100%; flex-wrap: nowrap; overflow-x: auto; justify-content: flex-start; }}
    }}
